...
import { ThreadBar } from "./thread-bar";
    ...
    threadTimeStamp,
        ...
        const {mutate: toggleReaction, isPending: isTogglingReactions} = useToggleReaction();
        ...
        return(
            ...
            <ConfirmDialog/>
            <div className={cn(
                "flex flex-col gap-2 p-1.5 px-5 hover:bg-gray-100/90 group relative",
    ...
    return(
        <>
        <ConfirmDialog/>
        <div className={cn("flex flex-col gap-2 p-1.5 px-5 hover:bg-gray-100/40 group relative",
